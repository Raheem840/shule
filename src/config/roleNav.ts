...
const SVG = {
  ...
  departments: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2z"/><path d="M22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7z"/></svg>`,
...
export const ROLE_NAV: Record<UserRole, RoleNav> = {
  ...
  // ── CLASS TEACHER ── Same as teacher + My Class (homeroom students)
  class_teacher: [
    {
      label: 'My Teaching',
      items: [
  ...
  dos: [
    {
      ...
      items: [
        ...
        { label: 'Students',      path: '/dos/students',          svg: SVG.students     },
  ...
  deputy: [
    {
      ...
      items: [
        ...
        { label: 'Departments',  path: '/deputy/departments',    svg: SVG.departments  },
        { label: 'Events',       path: '/deputy/events',         svg: SVG.attendance   },
  ...
  parent: [
    {
      ...
      items: [
        ...
        { label: 'Events',       path: '/parent/events',         svg: SVG.attendance   },
      ],
    },
  ],
  ...
  student: [
    {
      ...
      items: [
        ...
        { label: 'Events',       path: '/student/events',        svg: SVG.attendance   },
      ],
    },
  ],
  ...
  it_admin: [
    {
      ...
      items: [
        ...
        { label: 'Credentials',    path: '/admin/credentials',   svg: SVG.credentials      },
