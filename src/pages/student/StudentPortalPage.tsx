...
// per-child version — just two contacts. Uses the mature useMessages/
// useSendMessage/useUploadAttachment hooks (realtime + attachments), the same
// ones the staff-to-staff messaging system already uses, rather than the
// lighter parent-portal-specific hooks that don't support attachments.
function StudentChatThread({ contact, myId }: { contact: StaffContact; myId: string }) {
  ...
  return (
    <div className="portal-msg-shell" style={{ display: 'flex', height: '60vh', minHeight: 320, overflow: 'hidden' }}>
      ...
      <div className="portal-msg-thread" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        {selectedContact
          ? <StudentChatThread contact={selectedContact} myId={user!.id} />
