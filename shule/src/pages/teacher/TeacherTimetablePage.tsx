  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div>
        ...
        <div style={{ fontSize: 13, color: 'var(--txt3)', marginTop: 4 }}>Your assigned teaching periods for the selected term.</div>
      </div>
      ...
      {isLoading && <div style={{ color: 'var(--txt3)' }}>Loading your timetable…</div>}

      {!isLoading && slots.length === 0 && (
        <div style={{ color: 'var(--txt3)', padding: 32, textAlign: 'center', fontSize: 13,
          background: 'var(--surface)', borderRadius: 14, border: '1px solid var(--border)' }}>
          No timetable published for you this term.
        </div>
      )}
