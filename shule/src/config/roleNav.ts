  ...
  secretary: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Messages',     path: '/secretary/messages',    svg: SVG.messages     },
      ],
    },
  ],
  ...
  teacher: [
    {
      ...
      items: [
        ...
        { label: 'Enter Marks',  path: '/teacher/marks',         svg: SVG.enterMarks   },
    ...
    },
    {
      label: 'Reports',
      items: [
        { label: 'Report Preview',path: '/teacher/report-preview',svg: SVG.reportPreview},
  ...
  dos: [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Messages',     path: '/dos/messages',          svg: SVG.messages     },
      ],
    },
  ],
  ...
  deputy: [
    {
      ...
      items: [
        ...
        { label: 'Messages',     path: '/deputy/messages',       svg: SVG.messages     },
      ],
    },
  ],
